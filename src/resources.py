input_file = {'DR_5.3': 'assets/sample/DR_v5.3.csv', 'DR_5.2': 'assets/sample/DR_v5.2.csv', 'DR_5.1': 'assets/sample/DR_v5.1.csv',
...
labels = {'DR_5.3': 'Data release 5.3', 'DR_5.2': 'Data release 5.2', 'DR_5.1': 'Data release 5.1',
          'DR_4.0': 'Data release 4.0',
          'DR_3.0': 'Data release 3.0',
          'DR_2.1': 'Data release 2.1', 'DR_2.0': 'Data release 2.0',
          'DR_1.0': 'Data release 1.0'}

total_models = {'DR_5.3': 'assets/model/total_models_DR_v5.3.csv', 'DR_5.2': 'assets/model/total_models_DR_v5.2.csv', 'DR_5.1': 'assets/model/total_models_DR_v5.1.csv',
