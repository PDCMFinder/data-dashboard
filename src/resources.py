...
input_file = {
    ...
    'DR_6.1': 'assets/sample/DR_v6.1.csv', 'DR_6.0': 'assets/sample/DR_v6.0.csv',
...
labels = {'DR_6.1': 'Data release 6.1', 'DR_6.0': 'Data release 6.0',
...
total_models = {
    'DR_6.1': 'assets/model/total_models_DR_v6.1.csv', 'DR_6.0': 'assets/model/total_models_DR_v6.0.csv',
